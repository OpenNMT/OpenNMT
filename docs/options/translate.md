...
* `-tok_src_segment_alphabet <table>` (accepted: `Lao`, `Tamil`, `Latin`, `Khmer`, `Ogham`, `Tagbanwa`, `Malayalam`, `Gujarati`, `Hanunoo`, `Kangxi`, `Devanagari`, `Bopomofo`, `Greek`, `Bengali`, `Yi`, `Myanmar`, `Buhid`, `Gurmukhi`, `Hiragana`, `Hebrew`, `Kanbun`, `Oriya`, `Mongolian`, `Tagalog`, `Arabic`, `Katakana`, `Sinhala`, `Han`, `Ethiopic`, `Braille`, `Georgian`, `Armenian`, `Syriac`, `Cherokee`, `Thai`, `Kannada`, `Telugu`, `Limbu`, `Hangul`, `Thaana`, `Cyrillic`, `Tibetan`)<br/>Segment all letters from indicated alphabet.
* `-tok_tgt_segment_alphabet <table>` (accepted: `Lao`, `Tamil`, `Latin`, `Khmer`, `Ogham`, `Tagbanwa`, `Malayalam`, `Gujarati`, `Hanunoo`, `Kangxi`, `Devanagari`, `Bopomofo`, `Greek`, `Bengali`, `Yi`, `Myanmar`, `Buhid`, `Gurmukhi`, `Hiragana`, `Hebrew`, `Kanbun`, `Oriya`, `Mongolian`, `Tagalog`, `Arabic`, `Katakana`, `Sinhala`, `Han`, `Ethiopic`, `Braille`, `Georgian`, `Armenian`, `Syriac`, `Cherokee`, `Thai`, `Kannada`, `Telugu`, `Limbu`, `Hangul`, `Thaana`, `Cyrillic`, `Tibetan`)<br/>Segment all letters from indicated alphabet.
