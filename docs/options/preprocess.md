...
* `-tok_src_segment_alphabet <table>` (accepted: `Gurmukhi`, `Lao`, `Kanbun`, `Tibetan`, `Hiragana`, `Syriac`, `Latin`, `Malayalam`, `Oriya`, `Devanagari`, `Yi`, `Mongolian`, `Thaana`, `Katakana`, `Greek`, `Buhid`, `Armenian`, `Braille`, `Cherokee`, `Han`, `Telugu`, `Sinhala`, `Hangul`, `Myanmar`, `Limbu`, `Khmer`, `Hebrew`, `Tagbanwa`, `Tagalog`, `Hanunoo`, `Thai`, `Ogham`, `Ethiopic`, `Arabic`, `Kangxi`, `Georgian`, `Bengali`, `Tamil`, `Gujarati`, `Kannada`, `Bopomofo`, `Cyrillic`)<br/>Segment all letters from indicated alphabet.
* `-tok_tgt_segment_alphabet <table>` (accepted: `Gurmukhi`, `Lao`, `Kanbun`, `Tibetan`, `Hiragana`, `Syriac`, `Latin`, `Malayalam`, `Oriya`, `Devanagari`, `Yi`, `Mongolian`, `Thaana`, `Katakana`, `Greek`, `Buhid`, `Armenian`, `Braille`, `Cherokee`, `Han`, `Telugu`, `Sinhala`, `Hangul`, `Myanmar`, `Limbu`, `Khmer`, `Hebrew`, `Tagbanwa`, `Tagalog`, `Hanunoo`, `Thai`, `Ogham`, `Ethiopic`, `Arabic`, `Kangxi`, `Georgian`, `Bengali`, `Tamil`, `Gujarati`, `Kannada`, `Bopomofo`, `Cyrillic`)<br/>Segment all letters from indicated alphabet.
