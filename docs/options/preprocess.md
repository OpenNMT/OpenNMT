...
* `-tok_src_segment_alphabet <table>` (accepted: `Braille`, `Kangxi`, `Tamil`, `Arabic`, `Cherokee`, `Gurmukhi`, `Ethiopic`, `Tagbanwa`, `Greek`, `Sinhala`, `Bengali`, `Tagalog`, `Yi`, `Hangul`, `Hebrew`, `Katakana`, `Latin`, `Han`, `Limbu`, `Gujarati`, `Khmer`, `Georgian`, `Buhid`, `Hanunoo`, `Tibetan`, `Ogham`, `Kanbun`, `Thaana`, `Cyrillic`, `Lao`, `Thai`, `Malayalam`, `Kannada`, `Telugu`, `Myanmar`, `Hiragana`, `Oriya`, `Mongolian`, `Armenian`, `Bopomofo`, `Devanagari`, `Syriac`)<br/>Segment all letters from indicated alphabet.
* `-tok_tgt_segment_alphabet <table>` (accepted: `Braille`, `Kangxi`, `Tamil`, `Arabic`, `Cherokee`, `Gurmukhi`, `Ethiopic`, `Tagbanwa`, `Greek`, `Sinhala`, `Bengali`, `Tagalog`, `Yi`, `Hangul`, `Hebrew`, `Katakana`, `Latin`, `Han`, `Limbu`, `Gujarati`, `Khmer`, `Georgian`, `Buhid`, `Hanunoo`, `Tibetan`, `Ogham`, `Kanbun`, `Thaana`, `Cyrillic`, `Lao`, `Thai`, `Malayalam`, `Kannada`, `Telugu`, `Myanmar`, `Hiragana`, `Oriya`, `Mongolian`, `Armenian`, `Bopomofo`, `Devanagari`, `Syriac`)<br/>Segment all letters from indicated alphabet.
