...
local cmd = onmt.utils.ExtendedCmdLine.new('ensemble_translate.lua')
...
onmt.translate.EnsembleTranslator.declareOpts(cmd)
...
local function main()
  ...
  local translator = onmt.translate.EnsembleTranslator.new(opt)
